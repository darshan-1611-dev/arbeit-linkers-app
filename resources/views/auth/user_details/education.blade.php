...
@section("body")
    ...
    <section class="container">
        <form action="{{ url('/user-detail/education/store') }}" method="post" class="row">
            @csrf
            <div class="">
                <div class="my-5">
                ...
                <div class="col-sm-8" style="margin-top: 5rem !important;">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="degree_title" id="" class="form-select fs-4 py-3">
                                <option value="Bachelors" selected>Ex: Bachelors</option>
                                <option value="Doctor of Engineering (DEng)">Doctor of Engineering (DEng)</option>
                                <option value="Doctor of Musical Arts (DMA)selected">Doctor of Musical Arts
                                    (DMA)selected
                                </option>
                                ...
                                <option value="Master of Computer Applications (MCA)">Master of Computer Applications
                                    (MCA)
                                </option>
                                ...
                                <option value="Master of Public Administration (MPA)">Master of Public Administration
                                    (MPA)
                                </option>
                                ...
                                <option value="Master of Science in Project Management (MSPM)">Master of Science in
                                    Project
                                </option>
                                Management (MSPM)
                                <option value="Master of Science in Information Technology (MSc(IT))">Master of Science
                                    in
                                </option>
                                ...
                                <option value="Master of Computer Science (MSCS)">Master of Computer Science (MSCS)
                                </option>
                                <option value="Bachelor of Computer Science (BCompSc)">Bachelor of Computer Science
                                    (BCompSc)
                                </option>
                                <option value="Bachelor of Computer Applications">Bachelor of Computer Applications
                                </option>
                                <option value="Bachelor of Music (BM)">Bachelor of Music (BM)</option>
                                <option value="Bachelor of Science in Journalism">Bachelor of Science in Journalism
                                </option>
                                <option value="Master of Mass Communication and Journalism">Master of Mass Communication
                                    and
                                </option>
                                Journalism
                                <option value="Master of Educational Technology">Master of Educational Technology
                                </option>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control fs-4 py-3" name="field_of_study"
                                   value="{{ old("field_of_study") }}" placeholder="Ex: Business">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <select name="education_start_date" id="" class="form-select fs-4 py-3">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea class="form-control fs-4 py-3" name="education_description"
                                      ...
                                      style="resize: none;">{{ old("education_description") }}</textarea>
                        </div>
                        <div class="mb-5">
                            <input type="checkbox" name="is_education" id="" value="1" class="form-check-input me-2 mt-0 mt-sm-1"
                                   style="width: 2rem; height: 2rem;">
                            <label for="form-check-lable" class="fs-4 me-2 me-sm-4">Nothing to add? Check the box and
                                keep
                                going</label>
                        </div>
                </div>
            ...
            <div class="mt-5">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <input type="submit" value="Next, Add Languages"
                               class="btn al-btn">
                    </div>
                </div>
            </div>
