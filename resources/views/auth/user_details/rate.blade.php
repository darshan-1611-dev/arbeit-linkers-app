    ...
    <section class="container">
                        ...
                        <div class="mb-5">
                            <div class="row align-items-end justify-content-between">
                                <div class="col-9">
                                    ...
                                    <span class="text-danger fs-5"><i class="fas fa-exclamation-circle"></i> Enter your
                                        rate</span>
                                </div>
                                <div class="col-3">
        ...
        <div class="mt-5">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="{{ url("/user-detail/final_overview") }}"><input type="submit" value="Next, write an overview"
                                                                         class="btn al-btn"></a>
                </div>
            </div>
        </div>
