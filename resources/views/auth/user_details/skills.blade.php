...
@section("body")
    ...
    <section class="container">
        <form action="{{ url('/user-detail/skills/store') }}" method="post" class="row">
            @csrf
            <div class="row gx-5">
                <div class="col-md-7">
                    <div class="my-5">
                    ...
                    <div class="" style="margin-top: 5rem !important;">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control fs-4 py-3" name="skills" placeholder="Enter skills here">
                            <span class="text-muted fs-5"><i class="fas fa-exclamation-circle"></i> Add multiple skills by separating them with commas(ex. data scientist, web developer)</span>
                            <br>
                            @error('skills')
                ...
                <div class="col-md-4 d-none d-md-block mt-5 ms-5 px-5">
                    <div class="border rounded-3 p-5 mx-auto">
                        <div class="">
                            <img src="{{ asset('images/user_icon.jpeg') }}" alt="user_img"
                                 class="login-user-img rounded-circle"
            ...
            <div class="mt-5">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <input type="submit" value="Next, Write a Hourly Rate"
                               class="btn al-btn">
                    </div>
                </div>
            </div>
