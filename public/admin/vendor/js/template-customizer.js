    ...
    return (
      (function () {
        ...
        var x = [
          ...
          N = S.contains("layout-menu-offcanvas")
            ? "static-offcanvas"
            ...
            function t(e) {
              ...
              if (
                ...
                if (
                  ...
                  (this.settings.controls = n || x),
                  (this.settings.defaultTextDir = "rtl" === l || k),
                  (this.settings.defaultLayoutType = r || N),
                  (this.settings.defaultMenuCollapsed = void 0 !== c ? c : C),
                  (this.settings.defaultMenuFlipped = void 0 !== u ? u : A),
                  (this.settings.defaultShowDropdownOnHover =
                    void 0 !== d ? d : void 0),
                  (this.settings.defaultNavbarFixed = void 0 !== h ? h : T),
                  ...
                  (this.settings.styles = m || w),
                  (this.settings.defaultStyle = y || F),
                  (this.settings.lang = _ || "en"),
                  (this.pathResolver =
                    v ||
                    function (t) {
                      return t;
                  ...
                  var S = this.settings.controls.indexOf("style");
                  -1 !== S &&
                    (this.settings.controls = this.settings.controls
                      .slice(0, S)
                      .concat(this.settings.controls.slice(S + 1)));
                }
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (t =
                      ...
                      this._hasControls("style") ||
                        (this.settings.style = S.contains("dark-style")
                          ? "dark"
                          : "light"),
                      this._hasControls("layoutType") ||
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      if (this._hasControls("layoutType")) {
                        (this._controls.layoutType = b.querySelector(
